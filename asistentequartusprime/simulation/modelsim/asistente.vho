...
-- ledb	=>  Location: PIN_A10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- leda	=>  Location: PIN_B10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ledc	=>  Location: PIN_A9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ledd	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_N5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- switch	=>  Location: PIN_C10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst23|7~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \inst23|7~0_combout\ : std_logic;
SIGNAL \inst23|7~feeder_combout\ : std_logic;
SIGNAL \switch~input_o\ : std_logic;
SIGNAL \inst23|7~clkctrl_outclk\ : std_logic;
SIGNAL \inst23|11~0_combout\ : std_logic;
SIGNAL \inst23|11~q\ : std_logic;
SIGNAL \inst23|14~0_combout\ : std_logic;
SIGNAL \inst23|14~q\ : std_logic;
SIGNAL \inst21~combout\ : std_logic;
SIGNAL \inst23|7~q\ : std_logic;
...
SIGNAL \inst23|ALT_INV_7~clkctrl_outclk\ : std_logic;
...
\inst|inst|inst|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\inst11|LPM_MUX_component|auto_generated|muxlut_result3w~4_combout\ & \inst11|LPM_MUX_component|auto_generated|muxlut_result2w~3_combout\ & 
...
\inst23|7~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \inst23|7~q\);
\inst23|ALT_INV_7~clkctrl_outclk\ <= NOT \inst23|7~clkctrl_outclk\;
...
\ledb~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\leda~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\ledc~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\ledd~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
-- Equation(s):
-- \inst25~combout\ = LCELL((((\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2)) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0))) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1))) # 
-- (!\siguiente~input_o\))
...
\inst23|7~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst23|7~0_combout\ = !\inst23|7~q\
...
PORT MAP (
	datad => \inst23|7~q\,
	combout => \inst23|7~0_combout\);

-- Location: LCCOMB_X50_Y49_N0
\inst23|7~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst23|7~feeder_combout\ = \inst23|7~0_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \inst23|7~0_combout\,
	combout => \inst23|7~feeder_combout\);
...
\inst23|7~clkctrl\ : fiftyfivenm_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \inst23|7~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \inst23|7~clkctrl_outclk\);

-- Location: LCCOMB_X52_Y49_N18
\inst23|11~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst23|11~0_combout\ = !\inst23|11~q\
...
-- pragma translate_on
PORT MAP (
	clk => \inst23|ALT_INV_7~clkctrl_outclk\,
	d => \inst23|11~0_combout\,
...
\inst23|14~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst23|14~0_combout\ = (\inst23|14~q\) # (\inst23|11~q\)
...
-- Equation(s):
-- \inst21~combout\ = (\switch~input_o\) # (\inst23|14~q\)
...
-- Equation(s):
-- \inst13|inst1~combout\ = LCELL((\siguiente~input_o\ & (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2) & (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & 
...
-- Equation(s):
-- \inst6|inst1~combout\ = LCELL((\siguiente~input_o\ & (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2) & (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & 
-- !\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1)))))
...
-- Equation(s):
-- \inst26~combout\ = (\inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1))
...
-- pragma translate_on
PORT MAP (
	datac => \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0),
	datad => \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1),
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result0w~0_combout\ = (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1) & (!\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & 
-- ((!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0))))) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1) & (((\inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0)) # 
-- (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0)))))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result0w~1_combout\ = (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2) & ((\inst11|LPM_MUX_component|auto_generated|muxlut_result0w~0_combout\) # ((!\inst23|7~q\ & 
-- \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0)))))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result1w~2_combout\ = ((\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & (\inst23|11~q\ $ (!\inst23|7~q\)))) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result1w~0_combout\ = (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2) & ((\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0)) # 
-- ((\inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1)) # (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1)))))
...
PORT MAP (
	dataa => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0),
	datab => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2),
	datac => \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1),
	datad => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1),
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result1w~1_combout\ = (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & (\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1) $ 
-- (\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0))))
...
\inst11|LPM_MUX_component|auto_generated|muxlut_result1w~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result1w~3_combout\ = (\inst11|LPM_MUX_component|auto_generated|muxlut_result1w~0_combout\ & ((\inst11|LPM_MUX_component|auto_generated|muxlut_result1w~2_combout\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst11|LPM_MUX_component|auto_generated|muxlut_result1w~2_combout\,
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result2w~1_combout\ = (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & (\inst23|14~q\ $ (((!\inst23|7~q\ & !\inst23|11~q\)))))
...
-- ((!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2)))))
...
-- ((\inst11|LPM_MUX_component|auto_generated|muxlut_result2w~2_combout\) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst11|LPM_MUX_component|auto_generated|muxlut_result2w~1_combout\,
	datab => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1),
	datac => \inst11|LPM_MUX_component|auto_generated|muxlut_result2w~0_combout\,
	datad => \inst11|LPM_MUX_component|auto_generated|muxlut_result2w~2_combout\,
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~3_combout\ = (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & ((\inst23|14~q\) # ((\inst23|7~q\) # (\inst23|11~q\))))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~0_combout\ = (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2) & ((\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1)) # 
-- ((!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & \inst6|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(3)))))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~1_combout\ = (!\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0)) # (!\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1))
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~2_combout\ = (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0) & (\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(3) $ 
-- (((\inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2)) # (!\inst11|LPM_MUX_component|auto_generated|muxlut_result3w~1_combout\)))))
...
PORT MAP (
	...
	datab => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(0),
	datac => \inst13|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(2),
...
-- Equation(s):
-- \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~4_combout\ = (\inst11|LPM_MUX_component|auto_generated|muxlut_result3w~0_combout\ & (((\inst11|LPM_MUX_component|auto_generated|muxlut_result3w~3_combout\) # 
-- (\inst11|LPM_MUX_component|auto_generated|muxlut_result3w~2_combout\)) # (!\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(1))))
...
PORT MAP (
	...
	datad => \inst11|LPM_MUX_component|auto_generated|muxlut_result3w~2_combout\,
